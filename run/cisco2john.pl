...
# Basic Cisco type 4 - password encoder / decoder by Kost and Dhiru
#
# Usage: cisco2john.pl <Cisco type-4 hashes>
#
# Example:
#
# $ cisco2john.pl LcV6aBcc/53FoCJjXQMd7rBUDEpeevrK8V5jQVoJEhU
